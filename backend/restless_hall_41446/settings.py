"""
Django settings for restless_hall_41446 project.
...
ROOT_URLCONF = 'restless_hall_41446.urls'
...
WSGI_APPLICATION = 'restless_hall_41446.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "restless_hall_41446 API",
    "DESCRIPTION": "API documentation for restless_hall_41446 App",
    "VERSION": "v1",
}
